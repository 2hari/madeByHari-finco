          ...
          <div className="relative overflow-y-auto overflow-x-hidden h-[95vh] flex flex-col justify-between">
            ...
            <div className="px-3">
              ...
              <p className="text-gray-200 ">
                Fully fluid Responsive landing page built with Nextjs, Tailwind
                and daisy UI. React UI built from Figma Design.
              </p>
              <div className="mt-1 mb-16">
                <a
                  href="https://www.figma.com/file/uuIBhH7adFT3RQqghUsWu5/Finco?type=design&node-id=0%3A1&t=xxOa86AT1AiSXBnC-1"
